    ...
    <div className={styles.menu}>
      ...
      <div className={styles.input}>
        <div className='full-name'>
          {error === 'name required' && <p className='text-primary-main'>Name required</p>}
          <p>Full Name</p>
          <Input
            appearance='solid'
        ...
        <div className='email'>
          {error === 'email required' && <p className='text-primary-main'>Email required</p>}
          {error === 'P2002' && <p className='text-primary-main'>The character already exists</p>}
        ...
        <div className={styles.password}>
          {error === 'password required' && <p className='text-primary-main'>Password required</p>}
          {error === 'passwords didn’t match' && (
            <p className='text-primary-main'>Those passwords didn’t match. Try again.</p>
          )}
          <p>Password</p>
          <Input
            appearance='solid'
